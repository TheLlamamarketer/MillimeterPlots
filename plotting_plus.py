...
# '#eb3107'
def plot_data_plus(filename, datasets, ymin, ymax, ystep, xmax, xmin, xstep, marker = '.', ytickoffset=0, xtickoffset=0, grey_zones=None, width=20, height=28, background_color='#eb3107', x_label=None, y_label=None, legend_position='best'):
    ...
    for idx, data in enumerate(datasets):
        ...
        ax.errorbar(xdata, ydata, color=color, marker= marker, linestyle='solid', yerr=y_error, xerr=x_error, capsize=5, linewidth=0.5, elinewidth=0.1, capthick=1, clip_on=False, zorder=3, label=label)
