...
def main():
    ...
    sol_outer, interfaces_outer = solve_inverse_guess(res_outer.x, total_length, B, interfaces, end_margin=end_margin, max_nfev=1000, n_steps=400)

    continuity_diagnostics(sol_outer.x, total_length, B, interfaces_outer, end_margin=end_margin)
